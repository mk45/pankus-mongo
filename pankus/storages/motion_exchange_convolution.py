...
from pankus.defaults.config import \
    sd_start_key,sd_end_key,motion_exchange_convolution_name
...
motion_exchange_convolution = MongoCollectionStorageFactory(motion_exchange_convolution_name,[sd_start_key,sd_end_key])
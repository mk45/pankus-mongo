...
from pankus.defaults.config import \
    sd_start_key,sd_end_key,motion_exchange_withdrawal_excess_name
...
motion_exchange_withdrawal_excess =\
    MongoCollectionStorageFactory(motion_exchange_withdrawal_excess_name,[sd_start_key,sd_end_key])

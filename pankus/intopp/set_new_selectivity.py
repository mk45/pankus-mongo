...
from pankus.defaults.config import sd_id_key,in_ring_total_key,\
    destinations_key,ring_key,sd_start_key,sd_end_key,motion_quantity_key,\
    sources_key,selectivity_key
...
def set_new_selectivity(satisfaction_level=0.99):

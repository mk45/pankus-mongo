...
from pankus.defaults.config import \
    sd_surplus, id_key, start_key, end_key, weight_key, predecessor_key, successor_key
        ...
        while H != []:
            ...
            for edge in conn.find({start_key: n_id}):
                ...
                if new_dendryt[end_id][weight_key] > new_dendryt[n_id][weight_key] + weight:
                    ...
                    new_dendryt[end_id][predecessor_key] = new_dendryt[n_id][predecessor_key]
                    new_dendryt[end_id][successor_key] = n_id

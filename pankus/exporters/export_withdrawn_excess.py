...
from pankus.defaults.config import ring_key,sd_id_key,sd_start_key,sd_end_key,motion_quantity_key
import csv
...
def export_withdrawn_excess():
    ...
    fieldnames=[sd_start_key,sd_end_key,ring_key,motion_quantity_key]
